    ...
    stages{
       ...
       stage("deploy in tomcat"){
            steps{
                ...
                sh """
                    ssh -o StrictHostKeyChecking=no $JENKINS_HOME\workspace\jenkins_declarative_pipeline\web\target\time-tracker-web-0.5.0-SNAPSHOT.war  ec2-user@172.31.45.158:/opt/tomcat8/webapps/
